...
<img src="https://images.unsplash.com/photo-1541339907198-e08756dedf3f?w=1200&h=400&fit=crop&fm=webp" alt="Graduation cap and diploma" className="w-full h-full object-cover" />
...
className="col-span-1 text-slate-300 hover:text-red-400 text-lg font-bold transition-colors">x</button>
</div>
))}
</div>
...
"@type": "FAQPage",
"mainEntity": [
{"@type": "Question", "name": "How is GPA calculated?", "acceptedAnswer": {"@type": "Answer", "text": "GPA is calculated by multiplying each course grade (on a 4.0 scale) by its credit hours, summing all those values, then dividing by the total credit hours."}},
{"@type": "Question", "name": "What is a good GPA in college?", "acceptedAnswer": {"@type": "Answer", "text": "A GPA of 3.5 or above is generally considered very good and qualifies for Dean's List at most schools. A 3.0 (B average) is typically the minimum for graduate school applications."}},
{"@type": "Question", "name": "How do I calculate GPA with different credit hours?", "acceptedAnswer": {"@type": "Answer", "text": "Multiply each grade point value by the number of credit hours for that course. Sum all grade points, then divide by total credit hours."}},
{"@type": "Question", "name": "What is the difference between weighted and unweighted GPA?", "acceptedAnswer": {"@type": "Answer", "text": "An unweighted GPA uses a standard 4.0 scale. A weighted GPA gives extra points for harder courses like AP or honors classes, allowing scores above 4.0."}},
{"@type": "Question", "name": "How do I raise my GPA?", "acceptedAnswer": {"@type": "Answer", "text": "Focus on courses with high credit hours since they impact your GPA more. Retaking courses where you did poorly can also significantly improve your GPA."}},
{"@type": "Question", "name": "What GPA do you need to get into medical school?", "acceptedAnswer": {"@type": "Answer", "text": "Most medical schools look for a GPA of 3.5 or higher. The average GPA of accepted medical school students in the US is around 3.7."}}
]
})
}}
/>
...
{ q: "How do I raise my GPA?", a: "Focus on courses with high credit hours since they impact your GPA more. Retaking courses where you did poorly can also significantly improve your GPA." },
...
{q}
<span className="ml-4 text-slate-400 group-open:rotate-180 transition-transform">down</span>
</summary>
...
<Link href="/tools/grade-calculator" className="block p-4 rounded-xl border border-slate-200 hover:border-[#00B4A6] hover:shadow-md transition-all">
