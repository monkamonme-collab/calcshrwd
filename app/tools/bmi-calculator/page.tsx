    ...
    <>
      <div className="max-w-xl mx-auto px-6 py-10">
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "itemListElement": [
                ...
                { "@type": "ListItem", "position": 3, "name": "BMI Calculator", "item": "https://www.calcshrwd.com/tools/bmi-calculator" }
              ]
            })
          }}
        />
        ...
        <div className="relative w-full h-44 rounded-2xl overflow-hidden mb-6">
          <img
            src="https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=1200&h=400&fit=crop&fm=webp"
            alt="BMI calculator — measure your body mass index"
        ...
        <div className="mt-10 border-t border-slate-100 pt-8">
          <h2 className="text-2xl font-bold text-[#1E3A5F] mb-4">How Is BMI Calculated?</h2>
          <p className="text-slate-600 mb-4">
            BMI divides your weight by the square of your height. The formula differs by unit system:
          </p>
          <div className="bg-slate-50 border border-slate-200 rounded-xl p-5 mb-4 font-mono text-sm text-slate-700">
            ...
            <p className="mt-2"><strong>Imperial:</strong> BMI = (weight (lbs) × 703) ÷ height² (in)</p>
          </div>
          <p className="text-slate-600 mb-2 font-medium">Example — 5′9″, 170 lbs:</p>
          <ul className="text-slate-600 text-sm space-y-1 pl-4 list-disc">
            <li>Height in inches = 69 in</li>
            <li>BMI = (170 × 703) ÷ (69²) = 119,510 ÷ 4,761 = <strong>25.1 → Overweight</strong></li>
          </ul>
          <p className="text-slate-500 text-sm mt-3">
            <strong>Metric shortcut:</strong> Convert height to metres first (e.g. 175 cm = 1.75 m), then: 70 ÷ (1.75 × 1.75) = 70 ÷ 3.0625 = BMI 22.9 (Normal).
          </p>
        </div>

        {/* Learn More */}
        <div className="mt-8 border-t border-slate-100 pt-8">
          <h2 className="text-lg font-semibold text-[#1E3A5F] mb-3">Learn More About BMI</h2>
          <Link
          ...
          >
            <p className="font-medium text-slate-700">What Is BMI? Body Mass Index Explained Simply</p>
            <p className="text-sm text-slate-400 mt-1">
              How BMI is calculated, what the four categories mean, its well-known limitations, and better measures to track overall health.
            </p>
          </Link>
        </div>
      </div>
            ...
            __html: JSON.stringify({
              ...
              "mainEntity": [
                ...
                },
                {
                  ...
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "BMI is less accurate for women over 50 because it does not account for changes in muscle mass and fat distribution that come with age and menopause. A healthcare provider may recommend additional measurements like waist circumference or body fat percentage."
                  }
                },
                {
                  "@type": "Question",
