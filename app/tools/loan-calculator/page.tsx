    ...
    <>
      <div className="max-w-xl mx-auto px-6 py-10">
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "itemListElement": [
                ...
                { "@type": "ListItem", "position": 3, "name": "Loan Calculator", "item": "https://www.calcshrwd.com/tools/loan-calculator" }
              ]
            })
          }}
        />
        ...
        <div className="relative w-full h-44 rounded-2xl overflow-hidden mb-6">
          <img
            src="https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=1200&h=400&fit=crop&fm=webp"
            alt="Loan and finance concept"
            ...
            <div className="flex gap-2 mt-2 flex-wrap">
              {[12, 24, 36, 48, 60, 84, 120, 180, 360].map((m) => (
                <button
                  key={m}
                  onClick={() => {
                    setTermYears(String(Math.floor(m / 12)));
                    setTermMonths(String(m % 12));
                  }}
        ...
        <div className="mt-10 border-t border-slate-100 pt-8">
          <h2 className="text-2xl font-bold text-[#1E3A5F] mb-4">How Loan Interest Works</h2>
          <p className="text-slate-600 mb-4">
            Most personal and auto loans use <strong>simple amortizing interest</strong>: you pay the
            same amount every month, but the split between principal and interest shifts over time.
            Early payments are mostly interest; later payments are mostly principal.
          </p>
          <div className="bg-slate-50 border border-slate-200 rounded-xl p-5 mb-4 font-mono text-sm text-slate-700">
            <p>Monthly payment = P × [r(1+r)ⁿ] ÷ [(1+r)ⁿ − 1]</p>
            <p className="mt-1 text-xs text-slate-500">P = principal · r = monthly rate (APR ÷ 12) · n = total payments</p>
          </div>
          <p className="text-slate-600 mb-2 font-medium">Example — $20,000 loan at 7% APR for 5 years (60 months):</p>
          <ul className="text-slate-600 text-sm space-y-1 pl-4 list-disc">
            <li>Monthly rate r = 7% ÷ 12 = 0.5833%</li>
            <li>Monthly payment = <strong>$396</strong></li>
            <li>Total paid = $23,760 → <strong>$3,760 in interest</strong></li>
          </ul>
          <p className="text-slate-500 text-sm mt-3">
            <strong>Tip:</strong> Making one extra payment per year on a 5-year loan can cut 3–6 months
            off your term and save hundreds in interest.
          </p>
        </div>
        ...
        <div className="mt-8 border-t border-slate-100 pt-8">
          ...
          <Link
            href="/blog/understanding-loan-interest"
            className="block bg-white border border-slate-100 rounded-lg p-4 hover:border-[#00B4A6] transition-colors"
          >
            <p className="font-medium text-slate-700">Understanding Loan Interest: Simple vs Compound Explained</p>
            <p className="text-sm text-slate-400 mt-1">
              How amortization works, the difference between APR and interest rate, and strategies to pay off loans faster.
            </p>
          </Link>
        </div>
      </div>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "FAQPage",
              "mainEntity": [
                { "@type": "Question", "name": "How is a monthly loan payment calculated?", "acceptedAnswer": { "@type": "Answer", "text": "Monthly payment = P x [r(1+r)^n] / [(1+r)^n - 1], where P is the principal, r is monthly interest rate (annual rate ÷ 12), and n is number of payments." } },
                { "@type": "Question", "name": "What is the difference between APR and interest rate?", "acceptedAnswer": { "@type": "Answer", "text": "The interest rate is the cost of borrowing the principal. APR includes the interest rate plus other fees and costs, giving a more complete picture of the loan's total cost." } },
                { "@type": "Question", "name": "How do I pay off a loan faster?", "acceptedAnswer": { "@type": "Answer", "text": "Make extra payments directly toward the principal, pay biweekly instead of monthly, or round up your monthly payment. Even small extra amounts can save significant interest." } },
                { "@type": "Question", "name": "What credit score do I need for a personal loan?", "acceptedAnswer": { "@type": "Answer", "text": "Most lenders require a minimum credit score of 580–640. A score above 700 typically qualifies for the best interest rates." } },
                { "@type": "Question", "name": "How much does a $10,000 loan cost per month?", "acceptedAnswer": { "@type": "Answer", "text": "At 7% APR over 3 years: about $309/month. At 15% APR over 5 years: about $238/month but with much more total interest paid." } },
                { "@type": "Question", "name": "What is an amortization schedule?", "acceptedAnswer": { "@type": "Answer", "text": "A breakdown of each payment into principal and interest over the loan's life. Early payments are mostly interest; later payments are mostly principal." } }
              ]
            })
          }}
        />
